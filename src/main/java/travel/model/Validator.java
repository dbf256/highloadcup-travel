...
public class Validator {
    ...
    public boolean validate(User user, boolean isUpdate) {
        boolean idValid = (user.id == Constants.LONG_FIELD_MISSING && isUpdate) || (user.id != Constants.LONG_FIELD_MISSING);
        ...
        boolean birthDateValid = isUpdate || user.birthDate != Constants.LONG_FIELD_MISSING;
    ...
    public boolean validate(Location location, boolean isUpdate) {
        boolean idValid = (location.id == Constants.LONG_FIELD_MISSING && isUpdate) || (location.id != Constants.LONG_FIELD_MISSING);
    ...
    public boolean validate(Visit visit, boolean isUpdate) {
        boolean idValid = (visit.id == Constants.LONG_FIELD_MISSING && isUpdate) || (visit.id != Constants.LONG_FIELD_MISSING);
        boolean visitedValid = isUpdate || visit.visited != Constants.LONG_FIELD_MISSING;
